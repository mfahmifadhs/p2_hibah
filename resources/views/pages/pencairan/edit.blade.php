            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm rounded rounded-4">
                    <div class="card-header card-primary">
                        <h5 class="mb-0 fw-bold">Form Edit Pencairan Dana</h5>
                    </div>
                    <div class="card-body">
                        <form id="form-pencairan" action="{{ route('pencairan.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control number" id="nominal" name="total" placeholder="Masukkan nominal" value="{{ number_format($data->total, 0, ',', '.') }}" required>
                            </div>

                            <div class="mb-3">
                                <label for="perihal" class="form-label fw-bold">Perihal*</label>
                                <input type="text" class="form-control" id="perihal" name="perihal" placeholder="Masukkan perihal pencairan" value="{{ $data->perihal }}" required>
                            </div>

                            <div class="mb-3">
                                <label for="keterangan" class="form-label fw-bold">Keterangan</label>
                                <textarea class="form-control" id="keterangan" name="keterangan" rows="3" placeholder="Masukkan keterangan tambahan">{{ $data->keterangan }}</textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                @if ($data->lampiran)
                                    <input type="hidden" name="lampiran_data" value="{{ $data->lampiran }}">
                                    <div class="mb-2">
                                        <a href="{{ route('pencairan.lampiran', basename($data->lampiran)) }}" target="_blank" class="btn btn-sm btn-info">
                                ...
                                <small class="text-muted">Unggah file PDF baru (opsional).</small>
