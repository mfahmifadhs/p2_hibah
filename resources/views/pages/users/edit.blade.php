...
<div class="app-content">
    <div class="container-fluid col-md-10">
        <div class="card shadow-sm border-1 border-dark">
            ...
            <div class="card-body">
                <form id="form-update" action="{{ route('users.update', $data->id) }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <select id="pegawai" class="form-control select2" name="pegawai_id" style="width: 100%;" required>
                                    <option value="{{ $data->pegawai_id }}">{{ $data->pegawai->nama }}</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mb-2 mt-1">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control bg-light" name="password" id="passwordInput" value="{{ $data->password_text }}" placeholder="Password" required>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select name="akses" class="form-control">
                                    ...
                                    <option value="ksphln" <?=  $data->akses == 'ksphln' ? 'selected' : '';  ?>>KSPHLN</option>
                                    <option value="keuangan" <?=  $data->akses == 'keuangan' ? 'selected' : '';  ?>>Keuangan</option>
                                    <option value="pa" <?=  $data->akses == 'pa' ? 'selected' : '';  ?>>Program Anggaran</option>
                                </select>
                            </div>
                            <div class="col-md-6 mb-2">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="input-group">
                                    <input type="radio" id="true" name="status" value="true" {{ $data->status == 'true' ? 'checked' : '' }}>
                                    <label for="true" class="my-auto ml-2 mr-5">&nbsp; Aktif</label>
                                    &emsp;
                                    <input type="radio" id="false" name="status" value="false" {{ $data->status == 'false' ? 'checked' : '' }}>
