                    ...
                    <table id="table" class="table table-bordered text-center">
                        ...
                        <tbody class="text-sm">
                            ...
                            <tr>
                                ...
                                <td class="text-left">{{ $row->nama_uker }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
...
<div class="modal fade" id="editModal-{{ $row->id }}" aria-labelledby="edit" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formUpdate-{{ $row->id }}" action="{{ route('uker.update', $row->id) }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="uker" class="col-form-label">Nama Unit Kerja:</label>
                        <input type="text" class="form-control" id="uker" name="uker" value="{{ $row->nama_uker }}" required>
                    </div>
                </div>
