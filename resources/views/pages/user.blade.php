    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 my-auto">
                <h5 class="fw-bold">Total Anggaran Hibah</h5>
                <h1 class="fw-bold text-primary">Rp {{ $total->anggaran }}</h1>
            </div>
            <div class="col-md-6 my-auto">
                <h5 class="fw-bold">Total Realisasi Hibah</h5>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card shadow-sm border-0 rounded-4 p-3">
                    ...
                    <a href="{{ route('proyek.show', ['status' => 'true']) }}" class="d-flex align-items-center justify-content-between p-2 mb-2 rounded-3 bg-light hover-card text-dark text-decoration-none">
                        <div class="d-flex align-items-center gap-3">
                            <div class="icon-circle">
            ...
            <div class="col-md-9">
                <div class="card shadow-2xl border-0 rounded-4 p-1">

                    <div class="d-flex justify-content-between align-items-center mb-3 px-3 pt-3">
                        <h6 class="fw-bold mb-0">
                            Total Realisasi Jenis Kegiatan 2025 <br>
                        ...
                        <table class="table text-center">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-start">Alokasi</th>
                                    <th class="text-start">Realisasi</th>
                                    <th>Persentase</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($total->perJenis->sortByDesc('persentase') as $row)
                                <tr onclick="window.location=`{{ route('kegiatan.show', ['jenis_id' => $row->jenis_id ?? null]) }}`" style="cursor:pointer;">
