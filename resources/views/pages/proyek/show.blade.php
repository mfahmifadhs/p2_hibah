                        ...
                        $.each(response, function(index, item) {
                            ...
                            tbody.append(`
                                <tr>
                                    ...
                                    <td class="align-middle text-center" style="white-space: nowrap;">${item.total_idr}</td>
                                    <td class="align-middle text-center" style="white-space: nowrap;">${item.total_usd}</td>
