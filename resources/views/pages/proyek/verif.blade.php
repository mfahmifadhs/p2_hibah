    ...
    <div class="container-fluid col-md-8">
            ...
            <div class="card-body mx-5" style="overflow-y: scroll; max-height: 420px;">
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                        ...
                        <h6 class="mb-0">{{ $data->user->pegawai->uker->nama_uker }}</h6>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                        <span class="mx-2">:</span>
                        <h6 class="mb-0">{{ $data->donor->nama_donor }}</h6>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                        <span class="mx-2">:</span>
                        <h6 class="mb-0">{{ $data->kode_hibah }}</h6>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                        <span class="mx-2">:</span>
                        <h6 class="mb-0">{{ $data->no_register }}</h6>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                        <span class="mx-2">:</span>
                        <h6 class="mb-0">{{ $data->nama_proyek }}</h6>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                        <span class="mx-2">:</span>
                        <h6 class="mb-0">
                            {{ $data->periode_awal ? $data->periode_awal.' - '.$data->periode_akhir : $data->periode_akhir }}
                        </h6>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                        <span class="mx-2">:</span>
                        <h6 class="mb-0">Rp {{ number_format($data->total_budget_idr, 0, ',', '.') }}</h6>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                        <span class="mx-2">:</span>
                        <h6 class="mb-0">$ {{ number_format($data->total_budget_idr / 16000, 0, ',', '.') }}</h6>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                        <span class="mx-2">:</span>
                        <h6 class="mb-0">Rp {{ number_format($data->total_alokasi, 0, ',', '.') }}</h6>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                        <span class="mx-2">:</span>
                        <h6 class="mb-0">{{ $data->tahun_alokasi }}</h6>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                        <span class="mx-2">:</span>
                        <h6 class="mb-0" style="text-align: justify;">{{ $data->iss }}</h6>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                        <span class="mx-2">:</span>
                        <h6 class="mb-0" style="text-align: justify;">{{ $data->ikp }}</h6>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                        <span class="mx-2">:</span>
                        <h6 class="mb-0" style="text-align: justify;">{{ $data->ikk }}</h6>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                        <span class="mx-2">:</span>
                        <h6 class="mb-0" style="text-align: justify;">{{ $data->keterangan }}</h6>
                    </div>
                </div>
            </div>
        </div>
        <div class="mt-2">
            <div class="d-flex justify-content-end gap-2">
                <form id="form-false" action="{{ route('proyek.verif', $id) }}" method="GET">
                    @csrf
                ...
                <form id="form-true" action="{{ route('proyek.verif', $id) }}" method="GET">
                    @csrf
